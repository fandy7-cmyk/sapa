...
const MENUS = [
  {
    ...
    children: [
      { id: 'link',      key: 'superlink.link',      label: 'Link',      page: 'page-link',      loader: () => loadLinks(),      icon: `<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 3h6v6"/><path d="M10 14 21 3"/><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/></svg>` },
      { id: 'shortlink', key: 'superlink.shortlink',  label: 'Shortlink', page: 'page-shortlink',  loader: () => loadShortlinks(), icon: `<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z"/></svg>` },
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'pegawai', key: null, label: 'Pegawai / Struktur', page: 'page-pegawai', loader: () => { loadPegawai(); buildPegawaiJabatanFilter(); }, icon: `<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>` },
...
function navigateTo(subId, label, loader, groupId, pageId) {
  ...
  // Cari icon dari MENUS untuk ditampilkan di topbar
  const DASHBOARD_ICON = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="7" height="9" x="3" y="3" rx="1"/><rect width="7" height="5" x="14" y="3" rx="1"/><rect width="7" height="9" x="14" y="12" rx="1"/><rect width="7" height="5" x="3" y="16" rx="1"/></svg>`;
  let topbarIcon = subId === 'dashboard' ? DASHBOARD_ICON : '';
  if (!topbarIcon) {
    for (const g of MENUS) {
      const found = (g.children || []).find(c => c.id === subId);
      if (found && found.icon) { topbarIcon = found.icon; break; }
    }
  }
  const titleEl = document.getElementById('topbarTitle');
  if (topbarIcon) {
    titleEl.innerHTML = `<span style="display:inline-flex;align-items:center;gap:7px;vertical-align:middle"><span style="display:flex;opacity:.85;flex-shrink:0">${topbarIcon.replace(/width="\d+" height="\d+"/, 'width="16" height="16"')}</span>${esc(label)}</span>`;
  } else {
